...
// The above line had pre .pre in it and this caused issues with the code, removing solved the propblems
const Home = () => {
  return (
    <div>
      <h2>Home Page</h2>
...
// Using link with React the page no longer needs to reload
// Also remember to Capptalise things like Link and Routes when using them in react
const App = () => {
  return (
